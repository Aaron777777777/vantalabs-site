...
backup = ROOT / "guardian.before-minimal-editorial"
if backup.exists():
...
.moment{position:relative;padding-right:18px}
.moment::before{
  content:"";
  position:absolute;
  top:-24px;
  ...
  border-radius:50%;
  background:var(--gold);
  box-shadow:0 0 0 5px rgba(201,166,70,.07);
}
.moment-num{
  color:var(--soft);
  font-size:11px;
...
.simple-link span{color:var(--soft)}
...
@media(max-width:900px){
  .timeline{grid-template-columns:repeat(2,1fr);gap:42px 28px}
  .timeline::before{display:none}
  .moment{padding-top:18px;border-top:1px solid var(--line)}
  .moment::before{top:-5px}
  .feature-list{grid-template-columns:1fr}
  .feature{padding:28px 0;border-bottom:1px solid var(--line)}
...
@media(max-width:560px){
  ...
  .hero-icon{width:96px;height:96px;border-radius:21px}
  h1{font-size:46px}
  .lead{font-size:18px}
  .ctas .btn{width:100%}
...
<div class="timeline">
<article class="moment"><span class="moment-num">01</span><h3>Leaves Home</h3><p>The morning journey has started.</p></article>
<article class="moment"><span class="moment-num">02</span><h3>Arrives at School</h3><p>The reassuring arrival notification.</p></article>
<article class="moment"><span class="moment-num">03</span><h3>Leaves School</h3><p>The journey home has begun.</p></article>
<article class="moment"><span class="moment-num">04</span><h3>Arrives Home</h3><p>They made it back safely.</p></article>
</div>
</section>
...
<div class="link-list">
<a class="simple-link" href="/guardian/safe-zone-alerts/"><span><small>Safe zones</small><strong>Home and School alerts</strong></span><span>→</span></a>
<a class="simple-link" href="/guardian/child-location-tracker/"><span><small>Location</small><strong>Child location sharing</strong></span><span>→</span></a>
<a class="simple-link" href="/guardian/sos-alert-app-for-families/"><span><small>Urgent alerts</small><strong>Family SOS tools</strong></span><span>→</span></a>
<a class="simple-link" href="/guardian/guides/location-sharing-and-family-privacy/"><span><small>Parent guide</small><strong>Location sharing and privacy</strong></span><span>→</span></a>
</div>
</section>
</main>
...
print("Minimal editorial Guardian page applied.")
print("Backup created at guardian.before-minimal-editorial/")
